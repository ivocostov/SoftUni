...
from MainProblem.project import Dough
from MainProblem.project import Topping
...
class Pizza:
    def __init__(self, name: str, dough: Dough, max_number_of_toppings: int):
        ...
        self.toppings: Dict[str: float] = {}                                   # създава се речник с ключ str и стойност float
